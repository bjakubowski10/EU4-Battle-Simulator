...
class Army:
    ...
    def __init__(self,inf_amount : int, inf_combat, cav_combat, art_combat, cav_amount : int,art_amount : int,tech):
        self.inf_list = UnitFactory.inf_factory(inf_amount,inf_combat,tech)
        self.cav_list = UnitFactory.cav_factory(cav_amount,cav_combat,tech)
        self.art_list = UnitFactory.art_factory(art_amount,art_combat,tech)
    ...
    def fill_front_back_line(self):
        ...
        if inf_count < self.combat_width: #if there is less inf than combat width, add all to frontline
            ...
            if len(self.inf_list) > 0:
                ...
                self.inf_list.clear()
            print('frontline',len(self.frontline))
            ...
            if art_count > 0: 
                for unit in range(space_remaining):
                    ...
                    art_count -= 1
            print('frontline',len(self.frontline))
            print('backline',len(self.backline))
            ...
            print('backline',len(self.backline))                                
            print('======')
            print(len(self.cav_list))
            print(len(self.art_list))
            print(len(self.inf_list))
